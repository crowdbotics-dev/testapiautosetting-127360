...
## Project Structure
    ...
    ├── testapiautosetting_127360  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127360`
...
2. Clone this repo and `cd testapiautosetting_127360`
